...
const viewTodos = {
  renderTodos(todosArray, projectId) {
    ...
    titleTodo.textContent = `${todosArray.title}`;
...
export { viewTodos, addTodosBtn, renderTodosButton };
